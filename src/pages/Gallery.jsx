...
export default function Gallery() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <header className="bg-white border-b border-gray-100">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="flex items-center justify-between h-14 sm:h-16">
              ...
              {/* Logo */}
              <img src="/logo.png" alt="Cvetići" className="h-10 w-auto object-contain shrink-0" />
      ...
      {/* ── Contact Section ── */}
      <section id="kontakt" className="bg-white border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">Kontaktirajte nas</h2>
            <p className="text-gray-500 text-sm sm:text-base max-w-xl mx-auto">Imate pitanje ili želite da naručite? Tu smo za vas — pišite nam ili pozovite.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div className="flex flex-col gap-7">
              <h3 className="text-lg font-semibold text-gray-800">Kako da nas kontaktirate</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:radivojevic.ni@gmail.com" className="text-sm text-gray-800 hover:text-rose-600 transition-colors">radivojevic.ni@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+381693700575" className="text-sm text-gray-800 hover:text-rose-600 transition-colors">+381 69 37 00 575</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://www.instagram.com/cvetici.nis/" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-800 hover:text-rose-600 transition-colors">@cvetici.nis</a>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2.5">
                <li><a href="#" className="text-xs text-gray-500 hover:text-rose-600 transition-colors">Početna</a></li>
                <li><a href="#proizvodi" className="text-xs text-gray-500 hover:text-rose-600 transition-colors">Proizvodi</a></li>
                <li><a href="#kontakt" className="text-xs text-gray-500 hover:text-rose-600 transition-colors">Kontakt</a></li>
              </ul>
            </div>
            <div>
