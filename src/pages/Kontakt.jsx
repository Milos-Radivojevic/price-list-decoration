        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <nav className="hidden md:flex items-center gap-7">
              <Link to="/" className="text-sm font-medium text-gray-500 hover:text-rose-600 transition-colors">Početna</Link>
              <Link to="/" className="text-sm font-medium text-gray-500 hover:text-rose-600 transition-colors">Proizvodi</Link>
              <Link to="/kontakt" className="text-sm font-medium text-rose-600">Kontakt</Link>
            </nav>

            {/* Desktop right */}
            <div className="hidden md:flex items-center gap-5">
              <a href="tel:+381693700575" className="flex items-center gap-1.5 text-sm text-gray-600 hover:text-rose-600 transition-colors">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-gray-100 py-2 flex flex-col">
              <Link to="/" onClick={() => setMobileMenuOpen(false)} className="px-2 py-2.5 text-sm font-medium text-gray-600 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-colors">Početna</Link>
              <Link to="/" onClick={() => setMobileMenuOpen(false)} className="px-2 py-2.5 text-sm font-medium text-gray-600 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-colors">Proizvodi</Link>
              <Link to="/kontakt" onClick={() => setMobileMenuOpen(false)} className="px-2 py-2.5 text-sm font-medium text-rose-600 bg-rose-50 rounded-lg">Kontakt</Link>
            </div>
          )}
        </div>
      </header>
